...
// @include        https://gccomment.svn.sourceforge.net/*
// @include        http://ajax.aspnetcdn.com/*
// ==/UserScript==
...
function xmlhttpRequestBackground(details, answerPort) {
	...
	httpReq.onreadystatechange = function() {
		var resultData = {
			...
			// Hope this works
			// "finalUrl": (httpReq.readyState < 4 ? "" :
			// httpReq.responseXML.documentURI),
			"id" : details.id
		};
	...
	// open
	httpReq.open(details.method, details.url, true);
